...
public class ejerciciosWrappers {
    public static void main(String[] args) {
        ...
        Integer nume = Integer.valueOf("123");
        int valor = nume.intValue();
        ...
        Float numero1 = Float.parseFloat("9.75");
        Float resultado1 = numero1 + 1;
        ...
        Double numero2 = Double.parseDouble("45.678");
        ...
        Double nume1 = Double.parseDouble( number.nextLine() );
        Double nume2 = Double.parseDouble( number.nextLine() );
        ...
        Boolean bulean = Boolean.parseBoolean( sc.nextLine() );
        ...
        System.out.println( resultado3.charAt(0) );
